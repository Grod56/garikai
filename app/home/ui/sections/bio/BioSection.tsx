	...
	return (
		...
		>
			<div className="bio-text">
				<p>
					Welcome! You&apos;ve found my digital home. This place is
					the nexus of all of my interests, hobbies, and projects.
					Feel free to check out what interests you. You can get in
					touch with me through my{" "}
