...
import { removeMarkup } from "@/app/utility/RemoveMarkup";
        ...
        async function retrieveFocalPost(): Promise<FocalPostModel> {
            return await retrieve(true, focalPostEndPoint).then((allPosts) => {
                ...
                const focalPost: FocalPostModel = new FocalPostModel(
                    { id: postPreview.id, postURL: postPreview.linkURL, postThumbnailSource: postPreview.postThumbnailSource, postTitle: postPreview.postTitle, postText: postPreview.postText, postAuthor: postPreview.postAuthor, postDate: postPreview.postDate }                );
                return focalPost;
            });
        }
