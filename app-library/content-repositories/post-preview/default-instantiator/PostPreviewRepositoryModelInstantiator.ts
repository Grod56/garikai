import { instantiateFeaturedPostPreviewModel } from "@/app-library/components/content/post-preview/model-instantiator/FeaturedPostPreviewModelInstantiator";
...
} from "../PostPreviewRepositoryModel";

const imagePlaceholder = process.env
	.NEXT_PUBLIC_DEFAULT_IMAGE_PLACEHOLDER! as ImagePlaceholder;

export function instantiatePostPreviewRepository(api: PostPreviewAPI) {
